...
public class QuestionController {
     ...
     */
    @PostMapping
    public ResponseEntity<QuestionDTO> save(@Valid @RequestBody QuestionDTO questionDTO) throws Exception {
     ...
     */
    @PutMapping
    public ResponseEntity<QuestionDTO> update(@Valid @RequestBody QuestionDTO questionDTO) throws Exception {
